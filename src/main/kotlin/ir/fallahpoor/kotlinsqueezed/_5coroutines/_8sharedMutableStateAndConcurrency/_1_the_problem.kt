...
fun main() {
     ...
     * It presents all the usual concurrency problems. The main problem being synchronization of access to
     * shared mutable state.
     *
     * Let us launch a hundred coroutines all doing the same action a thousand times. We'll also measure
